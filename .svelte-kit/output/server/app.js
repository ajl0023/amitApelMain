...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-4b55157b.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-4b55157b.js", assets + "/_app/chunks/vendor-e483c085.js"]
    },
    fetched: void 0,
    floc: false,
...
const Bar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  `, 0)} class="${"cover-image svelte-tdftle"}"${add_attribute("src", initialLarge[index2].img, 0)} alt="${""}">`
    })}` : ``}
