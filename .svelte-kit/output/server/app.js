...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-66d27d1c.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-66d27d1c.js", assets + "/_app/chunks/vendor-e483c085.js"]
    },
    fetched: void 0,
    floc: false,
...
const Bar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(motion, "Motion").$$render($$result, {
    ...
    default: ({ motion: motion$1 }) => `<div${add_attribute("style", large ? `
      ...
      left:${initialLarge[index2].defaultPos.left}; opacity:1; width:10%; height:100%` : "opacity:0", 0)} class="${escape(large ? "large-bar" : "small-bar") + " single-bar-container svelte-1m6rfee"}">${large ? `${validate_component(motion, "Motion").$$render($$result, {
  ...
  `, 0)} class="${"cover-image svelte-1m6rfee"}"${add_attribute("src", initialLarge[index2].img, 0)} alt="${""}">`
    })}` : ``}
