...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-48c5beae.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-48c5beae.js", assets + "/_app/chunks/vendor-5b31feb5.js"]
    },
    fetched: void 0,
    floc: false,
...
createMotionProxy();
var main1 = "/_app/assets/SD Bar 1-03e1c9ee.mp4";
var main2 = "/_app/assets/SD Bar 2-71e00464.mp4";
var main3 = "/_app/assets/SD Bar 3-b3cd371d.mp4";
var main4 = "/_app/assets/SD Bar 4-fc01f970.mp4";
const largeBarsArr = [
  {
    delay: 0.1,
    defaultPos: {
...
const LargeBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div style="${"transform:scale(0.8)"}" class="${escape("") + " bar-container bar-" + escape(barObj.index) + " svelte-gnuj05"}"${add_attribute("this", bar, 0)}>${``}
  <video autoplay muted class="${"cover-image svelte-gnuj05"}"${add_attribute("src", barObj.img, 0)}${add_attribute("this", img, 0)}></video>
</div>`;
});
