...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-2a270c6f.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-2a270c6f.js", assets + "/_app/chunks/vendor-e483c085.js"]
    },
    fetched: void 0,
    floc: false,
...
const Bar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(motion, "Motion").$$render($$result, {
    ...
    default: ({ motion: motion$1 }) => `<div${add_attribute("style", large ? `top:0;height:100%;left:${initialLarge[index2].defaultPos.left}; opacity:1; width:10%; height:100%` : "opacity:0", 0)} class="${escape(large ? "large-bar" : "small-bar") + " single-bar-container svelte-100bbnt"}">${large ? `${validate_component(motion, "Motion").$$render($$result, {
      transition: { duration: 2, delay: 2 },
      animate: { opacity: 0 }
    }, {}, {
      default: ({ motion: motion2 }) => `<img width="${"100%"}" height="${"100%"}"${add_attribute("src", initialLarge[index2].img, 0)}${add_attribute("style", `opacity:1`, 0)} class="${"cover-image svelte-100bbnt"}" alt="${""}">`
    })}` : ``}
