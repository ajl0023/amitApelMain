...
var Marque_svelte_svelte_type_style_lang = '.logo-container.svelte-5ctk3t.svelte-5ctk3t{cursor:pointer;max-width:150px;position:relative;pointer-events:all;z-index:5}.logo-container.svelte-5ctk3t .logo.svelte-5ctk3t{width:100%}.container.svelte-5ctk3t.svelte-5ctk3t{margin:0;--color-text:#111;--color-bg:white;--color-link:#000;--color-link-hover:#000;--color-border:#a7927b;--marquee-bg:#000;--marquee-text:#fff;--menu-focus:#775e41;z-index:3;position:relative;background-color:white;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;background-image:url("__VITE_ASSET__112e1098__")}.menu-wrap.svelte-5ctk3t.svelte-5ctk3t{font-family:reason-new, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif;display:flex;background-size:cover;z-index:10;flex-direction:column;width:100vw;height:100vh;position:relative;justify-content:center}.top-nav-container.svelte-5ctk3t.svelte-5ctk3t{position:absolute;top:0;left:0;z-index:5;pointer-events:none;right:0;display:flex;padding-top:10px;flex-direction:column;justify-content:center;align-items:center}';
