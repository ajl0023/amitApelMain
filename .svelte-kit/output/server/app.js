...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-741c5941.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-741c5941.js", assets + "/_app/chunks/vendor-83c9f258.js"]
    },
    fetched: void 0,
    floc: false,
...
const metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-47ce7aa4.js", "css": [], "js": ["layout.svelte-47ce7aa4.js", "chunks/vendor-83c9f258.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-6aff4f89.js", "css": [], "js": ["error.svelte-6aff4f89.js", "chunks/vendor-83c9f258.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-3f49764a.js", "css": ["assets/pages/index.svelte-99e1c76b.css"], "js": ["pages/index.svelte-3f49764a.js", "chunks/vendor-83c9f258.js"], "styles": [] } };
...
var MenuItem_svelte_svelte_type_style_lang = "@keyframes svelte-spcbep-marquee{100%{transform:translate3d(-50%, 0, 0)}}.marquee__inner.svelte-spcbep.svelte-spcbep{animation:svelte-spcbep-marquee 15s linear infinite}.marquee__img.svelte-spcbep.svelte-spcbep{width:15vw;height:70%;margin:0 2vw;border-radius:5vw;background-size:cover;background-position:50% 50%}.menu__item.svelte-spcbep.svelte-spcbep{cursor:default;position:relative;overflow:hidden;z-index:4;text-align:center;box-shadow:0 -1px black}.menu__item.svelte-spcbep.svelte-spcbep:last-child{box-shadow:0 1px black, 0 -1px black}.menu__item-link.svelte-spcbep.svelte-spcbep{display:block;position:relative;cursor:pointer;color:black;text-decoration:none}.marquee.svelte-spcbep.svelte-spcbep{position:absolute;top:0;left:0;overflow:hidden;width:100%;height:100%;pointer-events:none;background:#68208e;transform:translate3d(0, 101%, 0)}.marquee__inner-wrap.svelte-spcbep.svelte-spcbep{height:100%;width:100%;transform:translate3d(0, -101%, 0)}.marquee__inner.svelte-spcbep.svelte-spcbep{height:100%;width:fit-content;align-items:center;display:flex;position:relative;animation:svelte-spcbep-marquee 15s linear infinite;will-change:transform}@keyframes svelte-spcbep-marquee{100%{transform:translate3d(-50%, 0, 0)}}.menu__item-link.svelte-spcbep.svelte-spcbep,.marquee.svelte-spcbep span.svelte-spcbep{white-space:nowrap;font-size:6vw;line-height:1.2;font-weight:600;padding:1vh 1vw 0;text-transform:uppercase}.marquee.svelte-spcbep span.svelte-spcbep{text-align:center;color:var(--marquee-text);font-weight:400}";
({
  3: {
    pages: [
      {
