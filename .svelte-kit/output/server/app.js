...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-5e69be9e.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-5e69be9e.js", assets + "/_app/chunks/vendor-e483c085.js"]
    },
    fetched: void 0,
    floc: false,
...
const Bar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(motion, "Motion").$$render($$result, {
    ...
    default: ({ motion: motion$1 }) => `<div${add_attribute("style", large ? `transform:scale(0.7);top:0;height:100%;left:${initialLarge[index2].defaultPos.left}; opacity:1; width:10%; height:100%` : "opacity:0", 0)} class="${escape(large ? "large-bar" : "small-bar") + " single-bar-container svelte-1wu9bqv"}">${large ? `${validate_component(motion, "Motion").$$render($$result, {
