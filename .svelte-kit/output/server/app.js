...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-562e55de.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-562e55de.js", assets + "/_app/chunks/vendor-c36717f7.js"]
    },
    fetched: void 0,
    floc: false,
...
const metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-e67bf651.js", "css": [], "js": ["layout.svelte-e67bf651.js", "chunks/vendor-c36717f7.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-0f72e216.js", "css": [], "js": ["error.svelte-0f72e216.js", "chunks/vendor-c36717f7.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-2ac3695b.js", "css": ["assets/pages/index.svelte-251b52f4.css"], "js": ["pages/index.svelte-2ac3695b.js", "chunks/vendor-c36717f7.js"], "styles": [] } };
...
const Bar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(motion, "Motion").$$render($$result, {
    ...
    default: ({ motion: motion$1 }) => `<div${add_attribute("style", large ? `top:0;height:100%;left:${initialLarge[index2].defaultPos.left}; opacity:0; width:10%; height:800px` : "opacity:0", 0)} class="${escape(large ? "large-bar" : "small-bar") + " single-bar-container svelte-1wu9bqv"}">${large ? `${validate_component(motion, "Motion").$$render($$result, {
      transition: { duration: 2, delay: 2 },
      animate: { opacity: 0 }
    }, {}, {
      default: ({ motion: motion2 }) => `<img width="${"100"}" height="${"100"}"${add_attribute("src", initialLarge[index2].img, 0)}${add_attribute("style", `opacity:1`, 0)} class="${"cover-image svelte-1wu9bqv"}" alt="${""}">`
    })}` : ``}
...
const Logo_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"bar-container svelte-1lu1tnu"}"${add_attribute("this", ele, 0)}>${each(bars, (bar, i) => `${validate_component(Bar, "Bar").$$render($$result, { ele, index: i, offset: offset[i] }, {}, {})}`)}
</div>`;
});
var Home_svelte_svelte_type_style_lang = '.container.svelte-5x9p6{background-repeat:no-repeat;font-family:Orator;color:white;background-size:cover;background-image:url("__VITE_ASSET__112e1098__");display:flex;flex-direction:column;justify-content:center;align-items:center;height:100vh;background-color:black;overflow:hidden}.container.svelte-5x9p6::before{position:absolute;top:0;bottom:0;left:0;right:0;width:100%;height:100%;content:"";z-index:1;background-color:rgba(0, 0, 0, 0.9)}h5.svelte-5x9p6{z-index:2;opacity:0;font-weight:100;font-size:4em;text-transform:uppercase}';
const css = {
  code: '.container.svelte-5x9p6{background-repeat:no-repeat;font-family:Orator;color:white;background-size:cover;background-image:url("../images/home/Background Photo.jpg");display:flex;flex-direction:column;justify-content:center;align-items:center;height:100vh;background-color:black;overflow:hidden}.container.svelte-5x9p6::before{position:absolute;top:0;bottom:0;left:0;right:0;width:100%;height:100%;content:"";z-index:1;background-color:rgba(0, 0, 0, 0.9)}h5.svelte-5x9p6{z-index:2;opacity:0;font-weight:100;font-size:4em;text-transform:uppercase}',
  map: '{"version":3,"file":"Home.svelte","sources":["Home.svelte"],"sourcesContent":["<script>\\r\\n  import { Motion } from \\"svelte-motion\\";\\r\\n\\r\\n  import Logo from \\"../images/Logo.svelte\\";\\r\\n  import backgroundImage from \\"../images/home/Background Photo.jpg\\";\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"container\\">\\r\\n  <Motion\\r\\n    transition={{ duration: 1, delay: 3 }}\\r\\n    let:motion\\r\\n    animate={{ opacity: 1 }}\\r\\n  >\\r\\n    <h5 use:motion>connecting people</h5>\\r\\n  </Motion>\\r\\n  <Logo />\\r\\n  <Motion\\r\\n    transition={{ duration: 1, delay: 3 }}\\r\\n    let:motion\\r\\n    animate={{ opacity: 1 }}\\r\\n  >\\r\\n    <h5 use:motion>to the art of living</h5>\\r\\n  </Motion>\\r\\n</div>\\r\\n\\r\\n<style lang=\\"scss\\">.container {\\n  background-repeat: no-repeat;\\n  font-family: Orator;\\n  color: white;\\n  background-size: cover;\\n  background-image: url(\\"../images/home/Background Photo.jpg\\");\\n  display: flex;\\n  flex-direction: column;\\n  justify-content: center;\\n  align-items: center;\\n  height: 100vh;\\n  background-color: black;\\n  overflow: hidden;\\n}\\n.container::before {\\n  position: absolute;\\n  top: 0;\\n  bottom: 0;\\n  left: 0;\\n  right: 0;\\n  width: 100%;\\n  height: 100%;\\n  content: \\"\\";\\n  z-index: 1;\\n  background-color: rgba(0, 0, 0, 0.9);\\n}\\n\\nh5 {\\n  z-index: 2;\\n  opacity: 0;\\n  font-weight: 100;\\n  font-size: 4em;\\n  text-transform: uppercase;\\n}</style>\\r\\n"],"names":[],"mappings":"AAyBmB,UAAU,aAAC,CAAC,AAC7B,iBAAiB,CAAE,SAAS,CAC5B,WAAW,CAAE,MAAM,CACnB,KAAK,CAAE,KAAK,CACZ,eAAe,CAAE,KAAK,CACtB,gBAAgB,CAAE,IAAI,qCAAqC,CAAC,CAC5D,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,MAAM,CAAE,KAAK,CACb,gBAAgB,CAAE,KAAK,CACvB,QAAQ,CAAE,MAAM,AAClB,CAAC,AACD,uBAAU,QAAQ,AAAC,CAAC,AAClB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,CAAC,CACR,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,CAAC,CACV,gBAAgB,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACtC,CAAC,AAED,EAAE,aAAC,CAAC,AACF,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,CAAC,CACV,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,GAAG,CACd,cAAc,CAAE,SAAS,AAC3B,CAAC"}'
};
const Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="${"container svelte-5x9p6"}">${validate_component(motion, "Motion").$$render($$result, {
    transition: { duration: 1, delay: 3 },
    animate: { opacity: 1 }
  }, {}, {
    default: ({ motion: motion2 }) => `<h5 class="${"svelte-5x9p6"}">connecting people</h5>`
  })}
  ...
  ${validate_component(motion, "Motion").$$render($$result, {
    ...
    default: ({ motion: motion2 }) => `<h5 class="${"svelte-5x9p6"}">to the art of living</h5>`
  })}
</div>`;
});
