...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-452af6c1.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-452af6c1.js", assets + "/_app/chunks/vendor-db31177c.js"]
    },
    fetched: void 0,
    floc: false,
...
const metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-e764271a.js", "css": [], "js": ["layout.svelte-e764271a.js", "chunks/vendor-db31177c.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-9acaa558.js", "css": [], "js": ["error.svelte-9acaa558.js", "chunks/vendor-db31177c.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-93a42ac6.js", "css": ["assets/pages/index.svelte-c9067868.css"], "js": ["pages/index.svelte-93a42ac6.js", "chunks/vendor-db31177c.js"], "styles": [] } };
...
const Bar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"bar-container svelte-a0xeke"}"${add_attribute("this", bar, 0)}></div>`;
});
var MenuItem_svelte_svelte_type_style_lang = "@keyframes svelte-toh3zy-marquee{100%{transform:translate3d(-50%, 0, 0)}}.marquee__inner.svelte-toh3zy.svelte-toh3zy{animation:svelte-toh3zy-marquee 15s linear infinite}.marquee__img.svelte-toh3zy.svelte-toh3zy{width:15vw;height:70%;margin:0 2vw;border-radius:5vw;background-size:cover;background-position:50% 50%}.menu__item.svelte-toh3zy.svelte-toh3zy{cursor:default;position:relative;overflow:hidden;z-index:4;text-align:center;box-shadow:0 -1px var(--color-border)}.menu__item.svelte-toh3zy.svelte-toh3zy:last-child{box-shadow:0 1px var(--color-border), 0 -1px var(--color-border)}.menu__item-link.svelte-toh3zy.svelte-toh3zy{display:block;position:relative;cursor:pointer;color:black;text-decoration:none}a.svelte-toh3zy.svelte-toh3zy:active{color:black}.marquee.svelte-toh3zy.svelte-toh3zy{position:absolute;top:0;left:0;overflow:hidden;width:100%;height:100%;pointer-events:none;background:#68208e;transform:translate3d(0, 101%, 0)}.marquee__inner-wrap.svelte-toh3zy.svelte-toh3zy{height:100%;width:100%;transform:translate3d(0, -101%, 0)}.marquee__inner.svelte-toh3zy.svelte-toh3zy{height:100%;width:fit-content;align-items:center;display:flex;position:relative;animation:svelte-toh3zy-marquee 15s linear infinite;will-change:transform}@keyframes svelte-toh3zy-marquee{100%{transform:translate3d(-50%, 0, 0)}}.menu__item-link.svelte-toh3zy.svelte-toh3zy,.marquee.svelte-toh3zy span.svelte-toh3zy{white-space:nowrap;font-size:6vw;line-height:1.2;font-weight:600;padding:1vh 1vw 0;text-transform:uppercase}.marquee.svelte-toh3zy span.svelte-toh3zy{text-align:center;color:var(--marquee-text);font-weight:400}";
var Marque_svelte_svelte_type_style_lang = '.frame.svelte-mikljk{position:fixed;text-align:left;z-index:3;top:0;left:0;display:grid;align-content:space-between;width:100%;max-width:none;height:100vh;padding:1.5rem 2rem 1rem;pointer-events:none;grid-template-columns:25% 50% 25%;grid-template-rows:auto auto auto;grid-template-areas:"logo credits links" "... ... ..." "... ... author"}.container.svelte-mikljk{margin:0;--color-text:#111;--color-bg:white;--color-link:#000;--color-link-hover:#000;--color-border:#a7927b;--marquee-bg:#000;--marquee-text:#fff;--menu-focus:#775e41;z-index:3;position:relative;background-color:transparent;font-family:reason-new, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}.menu-wrap.svelte-mikljk{display:flex;flex-direction:column;width:100vw;height:100vh;position:relative;justify-content:center}';
...
const LargeBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div style="${"transform:scale(0.6)"}" class="${escape("") + " bar-container bar-" + escape(barObj.index) + " svelte-rjl1is"}"${add_attribute("this", bar, 0)}>${``}
