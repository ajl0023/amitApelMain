...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-41393570.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-41393570.js", assets + "/_app/chunks/vendor-9b0d55d4.js"]
    },
    fetched: void 0,
    floc: false,
...
const metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-3e38a81a.js", "css": [], "js": ["layout.svelte-3e38a81a.js", "chunks/vendor-9b0d55d4.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-4446c5e6.js", "css": [], "js": ["error.svelte-4446c5e6.js", "chunks/vendor-9b0d55d4.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-8afe821b.js", "css": ["assets/pages/index.svelte-7d32a84c.css"], "js": ["pages/index.svelte-8afe821b.js", "chunks/vendor-9b0d55d4.js"], "styles": [] } };
...
var PageContent_svelte_svelte_type_style_lang = ".main-page-container.svelte-nwuqap{padding:20px;display:flex;padding-top:5rem;overflow-y:auto;overflow-x:hidden;height:100%;gap:25px;z-index:4;width:100vw;height:100vh;flex-direction:column;align-items:center;justify-content:center}";
...
var MalibuRebuild_svelte_svelte_type_style_lang = ".bottom-text-container.svelte-mydgu2.svelte-mydgu2{font-size:0.6em}.container.svelte-mydgu2.svelte-mydgu2{display:flex}.text-container.svelte-mydgu2.svelte-mydgu2{text-align:center;font-size:2em;display:flex;flex-direction:column;gap:20px;max-width:900px;color:#68208e}.text-container.svelte-mydgu2 p.svelte-mydgu2{font-size:0.8em}.text-container.svelte-mydgu2 p.svelte-mydgu2:last-child{font-size:0.6em}.text-container.svelte-mydgu2 .credit p.svelte-mydgu2{font-size:0.4em}";
...
var MeetTheTeam_svelte_svelte_type_style_lang = ".main-text-header.svelte-zszb6x{font-size:6em;font-weight:900;letter-spacing:3px;text-align:center;color:#68208e;text-transform:uppercase}.container.svelte-zszb6x{display:flex;flex-direction:column;align-items:center;justify-content:center}.card-container.svelte-zszb6x{display:flex;height:55vh;justify-content:center;position:relative;align-items:center}";
readable({
  x: 0,
  y: 0
}, (set) => {
