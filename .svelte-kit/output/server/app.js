...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-c752ad19.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-c752ad19.js", assets + "/_app/chunks/vendor-c447d8e0.js"]
    },
    fetched: void 0,
    floc: false,
...
const metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-a713ae11.js", "css": [], "js": ["layout.svelte-a713ae11.js", "chunks/vendor-c447d8e0.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-0e42c158.js", "css": [], "js": ["error.svelte-0e42c158.js", "chunks/vendor-c447d8e0.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-a528f76d.js", "css": ["assets/pages/index.svelte-38afd093.css"], "js": ["pages/index.svelte-a528f76d.js", "chunks/vendor-c447d8e0.js"], "styles": [] } };
...
var ArtImage_svelte_svelte_type_style_lang = ".item-container.svelte-12h0h3x.svelte-12h0h3x{max-width:400px;width:100%;cursor:pointer}.item-container.svelte-12h0h3x .image-container.svelte-12h0h3x{overflow:hidden;width:100%;height:auto}.item-container.svelte-12h0h3x .image-container .image.svelte-12h0h3x{height:100%;width:100%;opacity:0;object-fit:cover;object-position:center center}";
var Art_svelte_svelte_type_style_lang = ".container.svelte-1rixpyy{display:flex;flex-direction:column;justify-content:center;align-items:center;margin-top:6rem;width:100%}.flex-container.svelte-1rixpyy{display:flex;gap:10px;width:100%;margin-top:3rem;max-width:1700px}.main-text-header.svelte-1rixpyy{font-size:3em;line-height:0.8em;font-weight:900;letter-spacing:3px;font-family:unisansB;font-size:6em;text-align:center;color:#68208e;text-transform:uppercase}.flex-cm.svelte-1rixpyy{gap:10px;width:100%}";
...
var LeftArrow_svelte_svelte_type_style_lang = ".close-main.svelte-tyazq8{position:absolute;left:12px;display:block;cursor:pointer;width:32px;z-index:10}";
var Modal_svelte_svelte_type_style_lang = ".container.svelte-sgqcxr.svelte-sgqcxr{z-index:20;position:fixed;height:100vh;width:100vw;overflow-y:auto;top:0;display:flex;align-items:center;justify-content:center;right:0;background-color:rgba(10, 10, 10, 0.705)}.container.svelte-sgqcxr .image-container .image.svelte-sgqcxr{max-height:80vh;max-width:60vw;height:auto;width:auto;object-fit:cover;object-position:center center}";
var PageContent_svelte_svelte_type_style_lang = ".page-transition-black.svelte-po0a2s{background-color:black;width:100vw;position:absolute;bottom:0;height:0vh;z-index:3}.main-page-container.svelte-po0a2s{padding:20px;overflow-x:hidden;gap:25px;z-index:4;position:absolute;width:100vw;height:100%}";
readable({
  x: 0,
  y: 0
}, (set) => {
...
var PrivateHomes_svelte_svelte_type_style_lang = ".grid-item-container.svelte-1oeg30z.svelte-1oeg30z{display:flex;flex-direction:column}.grid-item-container.svelte-1oeg30z .label.svelte-1oeg30z{text-align:left;font-size:2em;line-height:0.8em;font-weight:900;letter-spacing:3px;font-family:unisansB;padding:1.2rem;color:#68208e;text-transform:uppercase}.grid-item-container.svelte-1oeg30z .image-container.svelte-1oeg30z{width:100%;cursor:pointer;height:300px}.grid-item-container.svelte-1oeg30z .image-container .grid-image.svelte-1oeg30z{object-fit:cover;width:100%;height:100%}.container.svelte-1oeg30z.svelte-1oeg30z{display:flex;flex-direction:column;align-items:center;width:100%;padding-top:10rem;justify-content:center}.gallery-container.svelte-1oeg30z.svelte-1oeg30z{margin-top:5rem;display:grid;max-width:1300px;width:100%;gap:31px;grid-template-columns:repeat(3, 1fr);grid-template-rows:repeat(3, 1fr)}.main-text-header.svelte-1oeg30z.svelte-1oeg30z{font-size:6em;line-height:0.8em;font-weight:900;letter-spacing:3px;font-family:unisansB;text-align:center;color:#68208e;text-transform:uppercase}";
...
var FurnitureImage_svelte_svelte_type_style_lang = ".label.svelte-nds9bs.svelte-nds9bs{transform:rotate(-180deg);writing-mode:vertical-lr;text-align:right;font-size:2em;line-height:0.8em;font-weight:900;letter-spacing:3px;font-family:unisansB;padding:1.2rem;color:#68208e;text-transform:uppercase}.item-container.svelte-nds9bs.svelte-nds9bs{display:flex;width:100%;cursor:pointer}.item-container.svelte-nds9bs .image-container.svelte-nds9bs{width:100%}.item-container.svelte-nds9bs .image-container .image.svelte-nds9bs{height:100%;width:100%;opacity:0;object-position:center center}";
var Furniture_svelte_svelte_type_style_lang = ".flex-column.svelte-u4lgja{gap:5px;flex-direction:column;display:flex;width:100%}.container.svelte-u4lgja{display:flex;flex-direction:column;justify-content:center;align-items:center;margin-top:6rem;width:100%}.flex-container.svelte-u4lgja{margin-top:3rem;display:flex}.main-text-header.svelte-u4lgja{font-size:6em;line-height:0.8em;font-weight:900;letter-spacing:3px;font-family:unisansB;text-align:center;color:#68208e;text-transform:uppercase}.flex-container.svelte-u4lgja{width:100%;max-width:1900px}";
...
var MenuItem_svelte_svelte_type_style_lang = "@keyframes svelte-15mzfcq-marquee{100%{transform:translate3d(-50%, 0, 0)}}.marquee__inner.svelte-15mzfcq.svelte-15mzfcq{animation:svelte-15mzfcq-marquee 15s linear infinite}.marquee__img.svelte-15mzfcq.svelte-15mzfcq{width:15vw;height:70%;margin:0 2vw;border-radius:5vw;background-size:cover;background-position:50% 50%}.menu__item.svelte-15mzfcq.svelte-15mzfcq{cursor:default;position:relative;overflow:hidden;z-index:5;font-family:unisansB;text-align:center;box-shadow:0 -1px black}.menu__item.svelte-15mzfcq.svelte-15mzfcq:last-child{box-shadow:0 1px black, 0 -1px black}.menu__item-link.svelte-15mzfcq.svelte-15mzfcq{display:block;position:relative;cursor:pointer;color:black;text-decoration:none}.marquee.svelte-15mzfcq.svelte-15mzfcq{position:absolute;top:0;left:0;overflow:hidden;width:100%;height:100%;pointer-events:none;background:#68208e;transform:translate3d(0, 101%, 0)}.marquee__inner-wrap.svelte-15mzfcq.svelte-15mzfcq{height:100%;width:100%;transform:translate3d(0, -101%, 0)}.marquee__inner.svelte-15mzfcq.svelte-15mzfcq{height:100%;width:fit-content;align-items:center;display:flex;position:relative;animation:svelte-15mzfcq-marquee 15s linear infinite;will-change:transform}@keyframes svelte-15mzfcq-marquee{100%{transform:translate3d(-50%, 0, 0)}}.menu__item-link.svelte-15mzfcq.svelte-15mzfcq,.marquee.svelte-15mzfcq span.svelte-15mzfcq{white-space:nowrap;font-size:6vw;line-height:1.2;font-weight:600;padding:1vh 1vw 0;text-transform:uppercase}.marquee.svelte-15mzfcq span.svelte-15mzfcq{text-align:center;color:var(--marquee-text);font-weight:400}";
({
  3: {
    pages: [
      {
...
var Marque_svelte_svelte_type_style_lang = '.logo-container.svelte-1qlsafe.svelte-1qlsafe{cursor:pointer;max-width:150px;position:relative;pointer-events:all;z-index:5}.logo-container.svelte-1qlsafe .logo.svelte-1qlsafe{width:100%}.container.svelte-1qlsafe.svelte-1qlsafe{margin:0;--color-text:#111;--color-bg:white;--color-link:#000;--color-link-hover:#000;--color-border:#a7927b;--marquee-bg:#000;--marquee-text:#fff;--menu-focus:#775e41;z-index:3;position:relative;background-color:white;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;background-image:url("__VITE_ASSET__112e1098__")}.menu-wrap.svelte-1qlsafe.svelte-1qlsafe{font-family:reason-new, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif;display:flex;background-size:cover;flex-direction:column;width:100vw;height:100vh;position:relative;justify-content:center}.top-nav-container.svelte-1qlsafe.svelte-1qlsafe{position:absolute;top:0;left:0;z-index:5;pointer-events:none;right:0;display:flex;padding-top:10px;flex-direction:column;justify-content:center;align-items:center}';
var LargeBar_svelte_svelte_type_style_lang = ".bar-container.svelte-1s2h8yk.svelte-1s2h8yk{width:100%;position:relative;height:100%;overflow:hidden}.main-label-container.svelte-1s2h8yk.svelte-1s2h8yk{text-transform:uppercase;position:absolute;opacity:0;font-size:1.4em;text-align:center;top:0}.cover-image.svelte-1s2h8yk.svelte-1s2h8yk{height:100%;object-position:center center;width:100%;object-fit:cover}.should-animate.svelte-1s2h8yk.svelte-1s2h8yk{opacity:0;pointer-events:none}.bar-wrapper.svelte-1s2h8yk.svelte-1s2h8yk{width:20%;top:0;display:flex;flex-direction:column;align-items:center;z-index:1;background-color:transparent;height:100%;position:absolute}.opened.svelte-1s2h8yk.svelte-1s2h8yk{z-index:3}.bar-3.svelte-1s2h8yk.svelte-1s2h8yk{left:0}.bar-3.svelte-1s2h8yk .main-label-container.svelte-1s2h8yk{top:-70px}.bar-17.svelte-1s2h8yk.svelte-1s2h8yk{left:20vw}.bar-17.svelte-1s2h8yk .main-label-container.svelte-1s2h8yk{top:-25px}.bar-23.svelte-1s2h8yk.svelte-1s2h8yk{right:20vw}.bar-23.svelte-1s2h8yk .main-label-container.svelte-1s2h8yk{top:-25px}.bar-28.svelte-1s2h8yk.svelte-1s2h8yk{right:0}.bar-28.svelte-1s2h8yk .main-label-container.svelte-1s2h8yk{top:-25px}";
...
var index_svelte_svelte_type_style_lang = ".container.svelte-qn8fgg{background:#000;width:100vw;height:100vh}";
const css = {
  code: ".container.svelte-qn8fgg{background:#000;width:100vw;height:100vh}",
  map: '{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script>\\r\\n  import { onMount } from \\"svelte\\";\\r\\n\\r\\n  import Home from \\"../components/Home.svelte\\";\\r\\n\\r\\n  import \\"../global.scss\\";\\r\\n\\r\\n  onMount(() => {\\r\\n    // function initMap() {\\r\\n    //   // The location of Uluru\\r\\n    //   const malibu = { lat: 34.0249999, lng: -118.773830238 };\\r\\n    //   // The map, centered at Malibu\\r\\n    //   const map = new google.maps.Map(document.getElementById(\\"map\\"), {\\r\\n    //     zoom: 10,\\r\\n    //     center: malibu,\\r\\n    //   });\\r\\n    //   // The marker, positioned at Uluru\\r\\n    //   const marker = new google.maps.Marker({\\r\\n    //     position: malibu,\\r\\n    //     map: map,\\r\\n    //   });\\r\\n    // }\\r\\n    // initMap();\\r\\n  });\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"container\\">\\r\\n  <Home />\\r\\n  <!-- <div id=\\"map\\" /> -->\\r\\n</div>\\r\\n\\r\\n<style lang=\\"scss\\">.container {\\n  background: #000;\\n  width: 100vw;\\n  height: 100vh;\\n}\\n\\n#map {\\n  width: 100%;\\n  height: 100%;\\n}</style>\\r\\n"],"names":[],"mappings":"AA+BmB,UAAU,cAAC,CAAC,AAC7B,UAAU,CAAE,IAAI,CAChB,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,AACf,CAAC"}'
};
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="${"container svelte-qn8fgg"}">${validate_component(Home, "Home").$$render($$result, {}, {}, {})}
